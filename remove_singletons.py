...
for count in range(0,2000): # range(len(transcript_list))                  ## looping over files in the transcript list
...
with open(str(datetime.date.today())+'_polymorphism_correlation.pickle', 'w') as f:
   pickle.dump((acorr_syn, acorr_nonsyn, normalizing_vector, acorr_syn_no_singleton, acorr_nonsyn_no_singleton, normalizing_vector_no_singleton), f)     
