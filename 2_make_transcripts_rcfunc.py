...
with open(contig+'_annotation.pickle', 'r') as f_anno:                    ##Opening the pickled file
...
outdir_mRNA = contig+'_mRNA'                                              ##Naming directory for a particular Contig
outdir_protein = contig+'_protein'
outdir_trans = contig+'_transcripts'
